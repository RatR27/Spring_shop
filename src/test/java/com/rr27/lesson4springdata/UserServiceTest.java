...
//                .when(userRepository)
//                .findOneByPhone("userJohn");
//        User userJohn = userService.findByPhone("userJohn");
//        Assert.assertNotNull(userJohn);
//        Mockito.verify(userRepository, Mockito.times(1)).findOneByPhone(ArgumentMatchers.eq("userJohn"));
